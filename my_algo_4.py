...
def ensemble_probas(probas_val1,probas_val2,probas_val3):
	res = (w1*probas_val1+w2*probas_val2+w3*probas_val3)/(w1+w2+w3)
	return res
# ====================================================================================================
...
max_queried = 377 # Determine the maximum number of queries that you want to carry out
...
print('==============================')
print('0:',models[0].__name__)
print('1:',models[1].__name__)
print('2:',models[2].__name__)
print('==============================')
